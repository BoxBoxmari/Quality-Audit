...
def test_parse_inline_formula_basic():
    ...
    res2 = validator._parse_inline_formula(
        "Lợi nhuận kế toán trước thuế (50 = 30 + (40 - 41) - 42)"
    )
    ...
    res3 = validator._parse_inline_formula(
        "Test user case (30 = 20 + (21 - 22) - 25 - 26)"
    )
    ...
    # Missing parentheses
    res4 = validator._parse_inline_formula(
        "This is an unclosed parens text 30 = 20 + 21 - 22 - 25 - 26)"
    )
